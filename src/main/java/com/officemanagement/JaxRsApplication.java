    ...
    public JaxRsApplication() {
        ...
        SwaggerConfiguration oasConfig =
                new SwaggerConfiguration()
                        .openAPI(oas)
                        .prettyPrint(true)
                        .resourcePackages(Set.of("com.officemanagement.resource"));

        // No need to manually set the configuration on OpenApiResource for JAX-RS
        // The OpenApiResource servlet will pick it up automatically if configured correctly
    }
