...
public class StatsResource {
    ...
    public Response getStats() {
        try {
            // Use EntityManager
            Long totalEmployees = entityManager.createQuery("SELECT COUNT(e) FROM Employee e", Long.class)
                                      .getSingleResult();

            Long totalFloors = entityManager.createQuery("SELECT COUNT(f) FROM Floor f", Long.class)
                                   .getSingleResult();

            Long totalOffices = entityManager.createQuery("SELECT COUNT(o) FROM OfficeRoom o", Long.class)
                                    .getSingleResult();

            Long totalSeats = entityManager.createQuery("SELECT COUNT(s) FROM Seat s", Long.class)
                                  .getSingleResult();
